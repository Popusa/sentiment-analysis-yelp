# -*- coding: utf-8 -*-
"""sarcasm_rnn_base_acc_00.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1D0AErYpsXKam0TeGv8CdURldc3rVIX06
"""
...
x = tf.keras.layers.SimpleRNN(int(RNN_UNITS), return_sequences=True)(x)
x = tf.keras.layers.Dropout(DROPOUT_VAL)(x)
x = tf.keras.layers.SimpleRNN(int(RNN_UNITS/2))(x)
x = tf.keras.layers.Dropout(DROPOUT_VAL)(x)
